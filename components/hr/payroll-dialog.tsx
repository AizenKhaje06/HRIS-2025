...
export function PayrollDialog({ open, onOpenChange, onSuccess, payroll, month, year }: PayrollDialogProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    night_differential: payroll?.night_differential?.toString() || "0",
    // Deductions
  ...
  useEffect(() => {
    if (payroll) {
      setFormData({
        ...
        night_differential: payroll.night_differential.toString(),
  ...
  const calculateTotals = () => {
    const totalIncome =
      ...
      (Number(formData.night_differential) || 0)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payrollData = {
        ...
        night_differential: Number(formData.night_differential),
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <div className="space-y-2">
                <Label htmlFor="night_differential">Night Differential</Label>
                <Input
                  id="night_differential"
                  type="number"
                  step="0.01"
                  value={formData.night_differential}
                  onChange={(e) => setFormData({ ...formData, night_differential: e.target.value })}
                />
              </div>
