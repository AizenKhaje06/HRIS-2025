...
interface Profile {
  ...
  probationary_start_date: string | null
  probationary_end_date: string | null
  created_at: string
}
  ...
  useEffect(() => {
    if (employee) {
      setFormData({
        ...
        probationary_start_date: employee.probationary_start_date || "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const employeeData = {
        ...
        bir_number: formData.bir_number || null,
        probationary_start_date: formData.probationary_start_date || null,
        probationary_end_date: formData.probationary_end_date || null,
      }
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              {formData.employment_status === "probationary" && (
                <>
                  <div className="space-y-2">
                    <Label htmlFor="probationary_start_date">Probationary Start Date</Label>
                    <Input
                      id="probationary_start_date"
                      type="date"
                      value={formData.probationary_start_date}
                      onChange={(e) => setFormData({ ...formData, probationary_start_date: e.target.value })}
                    />
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="probationary_end_date">Probationary End Date</Label>
                    <Input
                      id="probationary_end_date"
                      type="date"
                      value={formData.probationary_end_date}
                      onChange={(e) => setFormData({ ...formData, probationary_end_date: e.target.value })}
                    />
                  </div>
                </>
              )}
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-gray-900">Government ID Numbers</h3>
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setFormData({ ...formData, pagibig_number: e.target.value })}
                  placeholder="e.g., 1234-5678-9012"
                />
              </div>

              <div className="space-y-2">
                <Label htmlFor="bir_number">BIR # (TIN)</Label>
                <Input
                  id="bir_number"
                  value={formData.bir_number}
                  onChange={(e) => setFormData({ ...formData, bir_number: e.target.value })}
